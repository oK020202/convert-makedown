...
| **会社名**                           | **Cursor** | **Devin** | **GitHub Copilot** | **ChatGPT** | **Claude Code** | **WindSurf** | **公式情報（例：プレスリリース等）**                      |
| --------------------------------- | ---------- | --------- | ------------------ | ----------- | ------------ | ------------ | ----------------------------------------- |
...
| ランサーズ株式会社                      | 🌀          | 🌀         |                     |             | 🌀          | ✅           | （2025年3月から全エンジニアに「WindSurf」を導入、一部はCursor、Claude Code。参考（@https://x.com/waldo0515/status/1924749765159616592 ）） |
